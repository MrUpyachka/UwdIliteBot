...
ornul = ['как мразь', 'как тварь', 'как пидор', 'как шлеха', 'как алеша попович', 'как стерва', 'как орало', 'как орк', 'как сосеска', 'как барбареска']
...
def sendInfo(message):
	bot.send_message(message.chat.id, "Жду пул реквесты тут (и звездочки тоже) -> https://github.com/LikiPiki/UwdIliteBot")
